        ...
        <main className="flex-1 overflow-auto min-w-0">
          ...
          <header className="bg-white border-b border-slate-100 px-4 md:px-8 flex items-center justify-between sticky top-0 z-30 h-14">
            <div className="flex items-center gap-3">
              <button onClick={()=>setSideOpen(true)} className="md:hidden w-8 h-8 flex items-center justify-center rounded-lg text-slate-500 hover:bg-slate-100">
                <IMenu/>
              </button>
              <div className="hidden md:flex items-center gap-2">
                <div className="w-0.5 h-5 bg-[#C8880A] rounded-full"/>
                <p className="text-[11px] text-slate-400 font-semibold uppercase tracking-widest hidden lg:block">Mission Évangélique le Rocher de Sion — Guinée</p>
                <p className="text-[11px] text-slate-400 font-semibold uppercase tracking-widest lg:hidden">MERS — Guinée</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 md:gap-3">
              ...
              {/* Avatar → profil */}
              <Link to="/profil"
                className="w-8 h-8 rounded-xl bg-[#0D2B5E] flex items-center justify-center text-white text-[11px] font-bold hover:bg-[#1A5EA8] transition-colors cursor-pointer"
                title="Mon profil">
                {initials}
              </Link>
            </div>
